...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-6">
      <a href="admin/sanpham/them"><button type="button" class="btn btn-primary">Thêm Sản Phẩm</button></a>
      <a href="admin/sanpham/danhsach"><button type="button" class="btn btn-secondary">Về Danh sách</button></a>
    </div>
    <div class="col-sm-3"></div>
  </div>
</div>
